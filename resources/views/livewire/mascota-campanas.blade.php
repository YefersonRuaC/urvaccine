        ...
        transition-all duration-250 w-full mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="md:h-64 md:w-64 h-full w-full shadow-sm">
                    <a href="{{ route('mascotas.show', $campana->id) }}">
                ...
                <div class="flex flex-col justify-center items-center md:justify-start md:items-start">
                    <a href="{{ route('mascotas.show', $campana->id) }}" class="text-xl font-semibold text-gray-900 text-center md:text-left bg-orange-50
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center justify-center">
                ...
                <div class="md:col-span-2">
                    <a href="{{ route('mascotas.show', $campana->id) }}" class="flex justify-center items-center bg-orange-600 hover:bg-orange-700 text-white 
