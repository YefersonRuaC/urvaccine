        ...
        transition-all duration-250 w-full mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="md:h-64 md:w-64 h-full w-full shadow-sm">
                    <a href="{{ route('mascotas.show', $campana->titulo) }}">
                ...
                <div class="flex flex-col justify-center items-center md:justify-start md:items-start">
                    <a href="{{ route('mascotas.show', $campana->titulo) }}" class="text-xl font-semibold text-gray-900 text-center md:text-left bg-orange-50
                    hover:bg-orange-100 rounded-md py-1 px-3 shadow-sm">
                        {{ $campana->titulo }}
                    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center justify-center">
                <div class="col-span-3 flex flex-col items-center justify-center md:flex-row gap-2 md:gap-6 border-r border-gray-300">
                    ...
                    <p class="font-bold text-orange-800 text-xl">${{ number_format($campana->vacuna->precio, 0, '.', ',') }}</p>
                </div>
                <div class="md:col-span-2">
                    <a href="{{ route('mascotas.show', $campana->titulo) }}" class="flex justify-center items-center bg-orange-600 hover:bg-orange-700 text-white 
