<div>
    <form class="mx-auto mt-5 max-w-xl md:mt-5" wire:submit.prevent='editarCampana'>
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <div class="my-5 w-80">
                    ...
                    <img src="{{ asset('storage/campaigns/' . $imagen) }}" alt="{{ 'Imagen campaña ' . $titulo }}" 
                        class="object-cover w-full h-full shadow-md rounded-md"/>
