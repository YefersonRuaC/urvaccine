{{------------------------------------------ADMIN---------------------------------------------------}}
@if (auth()->user()->rol === 3)
<nav x-data="{ open: false }" class="bg-blue-50 border-b border-gray-200 p-4">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 md:-my-px md:ms-10 md:flex">
                    {{--Campañas--}}
                    <x-nav-link :href="route('campanas.index')" :active="request()->routeIs('campanas.index')" >
                        {{ __('Campañas') }}
                    </x-nav-link>
                    <x-nav-link :href="route('campanas.create')" :active="request()->routeIs('campanas.create')">
                        {{ __('Crear campaña') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('vacunas.create')" :active="request()->routeIs('vacunas.create')">
                        {{ __('Crear vacuna') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden md:flex md:items-center md:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" class="font-bold text-blue-900 flex gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" class="text-red-700 font-bold flex gap-1"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1">
            {{--Campañas--}}
            <x-responsive-nav-link :href="route('campanas.index')" :active="request()->routeIs('campanas.index')">
                {{ __('Campañas') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('campanas.create')" :active="request()->routeIs('campanas.create')">
                {{ __('Crear campaña') }}
            </x-responsive-nav-link>

            {{--Vacunas--}}
            <x-responsive-nav-link :href="route('vacunas.index')" :active="request()->routeIs('vacunas.index')">
                {{ __('Vacunas') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')" class="text-blue-700 bg-white border-blue-700 flex gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" />
                    </svg>
                    {{ __('Perfil') }}
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')" class="border-red-700 bg-red-50 text-red-700 flex gap-1"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            <path fill-rule="evenodd" d="M16.5 3.75a1.5 1.5 0 0 1 1.5 1.5v13.5a1.5 1.5 0 0 1-1.5 1.5h-6a1.5 1.5 0 0 1-1.5-1.5V15a.75.75 0 0 0-1.5 0v3.75a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V5.25a3 3 0 0 0-3-3h-6a3 3 0 0 0-3 3V9A.75.75 0 1 0 9 9V5.25a1.5 1.5 0 0 1 1.5-1.5h6ZM5.78 8.47a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 0 0 0 1.06l3 3a.75.75 0 0 0 1.06-1.06l-1.72-1.72H15a.75.75 0 0 0 0-1.5H4.06l1.72-1.72a.75.75 0 0 0 0-1.06Z" clip-rule="evenodd" />
...
@if (auth()->user()->rol === 1)
<nav x-data="{ open: false }" class="bg-green-50 border-b border-gray-200 p-4">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
            ...
            <div class="hidden md:flex md:items-center md:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" class="text-blue-700 font-bold flex gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" />
                            </svg>
                            {{ __('Perfil') }}
...
@if (auth()->user()->rol === 2)
<nav x-data="{ open: false }" class="bg-orange-50 border-b border-gray-200 p-4">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
